...
#define ATWORKGIF "http://your.web.server/webdirforurl/gnt/icons/at-work.gif"
#define GNTPROG "http://your.web.server/webdirforurl/cgi-bin/gnt"
#define GNTHOME "http://your.web.server/webdirforurl/gnt"
#define LOCKFILE "/webdir/gnt/gnt.lck"
...
extern void hfatals(char*);						/* from util */
extern void hfatalfs(char*, char*);					/* from util */
extern void hfatalfd(char*, int = 0, int = 0, int = 0, int = 0);	/* from util */
